...
def currency_create(request):
    if request.method=='GET':
        return Response({'data':'','module':'Currency'},template_name='currency/currency_create_update.html')
    else:
        serializer=CurrencySerializer(data=request.data)
        if serializer.is_valid():
            serializer.save();
            if request.accepted_renderer.format=='html':
                return Response({"success_data": "Data added successfully"},template_name='currency/currency_create_update.html')
            ...
            if request.accepted_renderer.format=='html':
                return Response({"error_data": data},template_name='currency/currency_create_update.html')
...
def currency_list(request):
    ...
    if request.accepted_renderer.format == 'html':
        return Response({"data":currency_data,'module':'Currency',"custom_filter":custom_filter},template_name='currency/currency_list.html')
...
def currency_view(request,id):
    ...
    if request.accepted_renderer.format == 'html':
        return Response({"data":currency_data,'module':'Currency',"view_mode":1},template_name='currency/currency_create_update.html')
...
def currency_update(request,id):
    ...
    if request.method=='GET':
        ...
        if request.accepted_renderer.format == 'html':
            return Response({'data':data},template_name='currency/currency_create_update.html')
