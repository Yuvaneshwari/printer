...
def state_create(request):
    if request.method=='GET':
        return Response({'data':'','module':'State'},template_name='state/state_create_update.html')
    else:
        serializer=StateSerializer(data=request.data)
        if serializer.is_valid():
            serializer.save();
            if request.accepted_renderer.format=='html':
                return Response({"success_data": "Data added successfully"},template_name='state/state_create_update.html')
            ...
            if request.accepted_renderer.format=='html':
                return Response({"error_data": data},template_name='state/state_create_update.html')
...
def state_list(request):
    ...
    if request.accepted_renderer.format == 'html':
        return Response({"data":state_data,'module':'State',"custom_filter":custom_filter},template_name='state/state_list.html')
...
def state_view(request,id):
    ...
    if request.accepted_renderer.format == 'html':
        return Response({"data":state_data,'module':'State',"view_mode":1},template_name='state/state_create_update.html')
...
def state_update(request,id):
    ...
    if request.method=='GET':
        ...
        if request.accepted_renderer.format == 'html':
            return Response({'data':data},template_name='state/state_create_update.html')
